...
//   else     BUS_ERR
// 你只需填“仲裁区间判定”三条 assign（下方 ── 学生填 ──）；bus_err/dev 派生与 tb 勿改。
...
module busarb (
    ...
    assign sel_reg = 1'b0; // TODO: (addr >= REG_BASE) && (addr < REG_END)
    assign sel_sen = 1'b0; // TODO: (addr >= SEN_BASE) && (addr < SEN_END)
    assign sel_sw  = 1'b0; // TODO: (addr >= SW_BASE)  && (addr < SW_END)
    // 以下由 sel 派生（勿改）：
