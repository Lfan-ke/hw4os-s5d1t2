...
> 目的：让学生理解OS，是管理硬件分配资源的，以后无论出什么千奇百怪的核、外设、硬件，如有需要都想起OS的核心思想们，能造一个普适的，适合的，适用的，资源管理分配系统。
...
| 赛道 | 性质 | 学什么 | 数量 |
|---|---|---|---|
| **不正经 improper** | 心智模型 | 用最朴素的软件/硬件模型，把每个 OS 子系统的「本质」直接演给你看（块设备=数组，MMU=软件页表，特权级=几根线） | 18 |
...
>
> 三轨完整实验序列、推荐学习顺序与依赖见 docs/tutorial.md（课程路线书）。
