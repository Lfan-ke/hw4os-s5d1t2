...
#
# Two routes (see ../core/apks/SOURCES-python-apks.md):
...
# tgoskits checkout (rootfs imgs under tmp/axbuild/rootfs/); the apk closure + apk-closure.py
# are SHARED with python/core and live at ../core/apks/ (not duplicated here). No abs paths.
