...
module mkBusArb (BusArb);
   ...
   method Dev route(Addr a);
      if      (a >= 32'h4000_0000 && a < 32'h4000_1000) return DevReg;
      else if (a >= 32'h4001_0000 && a < 32'h4001_0010) return DevSensor;
      else if (a >= 32'h4002_0000 && a < 32'h4002_0010) return DevSwitch;
      else return DevErr;
   endmethod
endmodule
